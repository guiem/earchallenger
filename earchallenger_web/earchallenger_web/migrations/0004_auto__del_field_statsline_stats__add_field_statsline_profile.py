...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StatsLine.stats'
        db.delete_column(u'earchallenger_web_statsline', 'stats_id')

        # Adding field 'StatsLine.profile'
        db.add_column(u'earchallenger_web_statsline', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['earchallenger_web.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StatsLine.stats'
        db.add_column(u'earchallenger_web_statsline', 'stats',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['earchallenger_web.UserProfile']),
                      keep_default=False)

        # Deleting field 'StatsLine.profile'
        db.delete_column(u'earchallenger_web_statsline', 'profile_id')
    ...
    models = {
        ...
        'earchallenger_web.statsline': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['earchallenger_web.UserProfile']"}),
